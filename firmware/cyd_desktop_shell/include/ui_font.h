...
namespace cyd::desktop::ui {

// 5x7 glyphs in a 6x8 cell, derived from the original Adafruit_GFX font
// distributed with TFT_eSPI (MIT/BSD licensed). Columns are stored LSB-top.
